      ...
      <div class="col-md-4">
        ...
        <div class="box box-primary">
          ...
          <div class="box-body box-profile">
            ...
            <a href="#" class="btn btn-danger btn-block btn-flat btn-delete-item" data-title="{{ __('common.confirm_deletion_message') }}" data-confirm="{{ __('common.are_you_sure_you_want_to_delete') }}">
              <b>{{ __('posts.delete') }}</b>
            </a>
          </div>
          <!-- /.box-body -->
              ...
              <table id="list-comments" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td class="text-center" width="15%">
                    <a href="#" class="btn btn-danger btn-flat fa fa-trash-o btn-delete-item" data-title="{{ __('common.confirm_deletion_message') }}" data-confirm="{{ __('common.are_you_sure_you_want_to_delete') }}"></a>
                  </td>
                </tr>
                <tr>
